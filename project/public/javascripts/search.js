...
function showResults() {
    ...
    if (totalPages <= 7){  // 如果 totalPages <= 7页，全部显示
        addSuccessivePageButton(1, totalPages);
    }
        ...
        switch (currentPage){
            ...
            default:
                addFirstPageButton();
                addDotsPageButton(Math.ceil((1 + currentPage-1)/2));
                addSuccessivePageButton(currentPage-1, currentPage+1);
                addDotsPageButton(Math.ceil((currentPage+1 + totalPages)/2));
                addLastPageButton();
        }
    }

    // 首页
    function addFirstPageButton() {
    ...
    // ...
    function addDotsPageButton(page) {
        var li = document.createElement('li');
        var a = document.createElement('a');
        a.innerText = '...';
        a.id = '...';
    ...
    // 连续页
    function addSuccessivePageButton(start, end) {
